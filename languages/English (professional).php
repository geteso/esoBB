...
// Installer strings.
"Welcome to the esoBB installer" => "Welcome to the esoBB installer",
"Thank you for choosing the esoBB forum software. Using the installer, you can have your forum ready to go in three easy steps. For more information, you may consult the setup guide or get help on the esoBB support forum." => "Thank you for choosing the esoBB forum software. Using the installer, you can have your forum ready to go in three easy steps. For more information, you may consult the <a href='https://geteso.org/docs/setup' class='external' target='_blank'>setup guide</a> or get help on the <a href='https://forum.geteso.org' class='external' target='_blank'>esoBB support forum</a>.",
"Select your language" => "Select your language",
"Installer language" => "Installer language",
"Next step" => "Next step",
"Try again" => "Try again",
"Go back" => "Go back",
"Take me to my forum" => "Take me to my forum!",
"Uh oh, something's not right" => "Uh oh, something's not right!",
"Warning" => "Warning!",
"Specify setup information" => "Specify setup information",
"We need a few details from you so we can get your forum ready to go. If you have any trouble, read the setup guide or get help on the esoBB support forum." => "We need a few details from you so we can get your forum ready to go. If you have any trouble, read the <a href='https://geteso.org/docs/setup' class='external' target='_blank'>setup guide</a> or get help on the <a href='https://forum.geteso.org' class='external' target='_blank'>esoBB support forum</a>.",
"Specify basic details" => "Specify basic details",
"Forum title" => "Forum title",
"Forum description" => "Forum description",
"Default language" => "Default language",
"More language packs are available for download" => "More language packs are <a href='https://geteso.org/languages' class='external' target='_blank'>available for download</a>.",
"Configure the database" => "Configure the database",
"esoBB needs a database to store all your forum's data in, such as conversations and posts. If you're unsure of any of these details, you may need to ask your hosting provider." => "esoBB needs a database to store all your forum's data in, such as conversations and posts. If you're unsure of any of these details, you may need to ask your hosting provider.",
"MySQL host address" => "MySQL host address",
"MySQL username" => "MySQL username",
"MySQL password" => "MySQL password",
"MySQL database" => "MySQL database",
"Outgoing mail server" => "Configure the mail server",
"esoBB needs a mail server to send emails to members, but your forum will work with email sending disabled. If you haven't configured server-side email sending or are unsure of whether you can send emails, leave this disabled and change it later." => "esoBB needs a mail server to send emails to members, but your forum will work with email sending disabled. If you haven't configured server-side email sending or are unsure of whether you can send emails, leave this disabled and change it later.",
"Send emails" => "Send emails",
"SMTP mail server (optional)" => "SMTP mail server (optional)",
"SMTP authentication" => "SMTP authentication",
"None at all (internal email)" => "None at all (internal email)",
"SMTP host address" => "SMTP host address",
"SMTP host port" => "SMTP host port",
"SMTP username" => "SMTP username",
"SMTP password" => "SMTP password",
"Administrator account" => "Create your account",
"esoBB will use the following information to set up your administrator account on your forum." => "esoBB will use the following information to set up your administrator account on your forum.",
...
"MySQL character set" => "MySQL character set",
"MySQL storage engine" => "MySQL storage engine",
"InnoDB (recommended)" => "InnoDB (recommended)",
"MyISAM (less efficient, smaller)" => "MyISAM (less efficient, smaller)",
"Hashing algorithm" => "Hashing algorithm",
"bcrypt (recommended)" => "bcrypt (recommended)",
"MD5 (less secure, faster)" => "MD5 (less secure, faster)",
"Base URL" => "Base URL",
"Use friendly URLs" => "Use friendly URLs",
"The following errors were found with your forum's setup. They must be resolved before you can continue the installation." => "The following errors were found with your forum's setup. They must be resolved before you can continue the installation.",
"The following errors were found with your forum's setup. You can continue the installation without resolving them, but some functionality may be limited." => "The following errors were found with your forum's setup. You can continue the installation without resolving them, but some functionality may be limited.",
"If you run into any other problems or just want some help with the installation, feel free to join the esoBB support forum where a bunch of friendly people will be happy to help you out." => "If you run into any other problems or just want some help with the installation, feel free to join the <a href='https://forum.geteso.org' class='external' target='_blank'>esoBB support forum</a> where a bunch of friendly people will be happy to help you out.",
"Uh oh! It's a fatal error" => "Uh oh! It's a fatal error...",
"The forum installer encountered an error." => "The forum installer encountered an error.",
"The esoBB installer has encountered a nasty error which is making it impossible to install a forum on your server. But don't feel down, here are a few things you can try" => "The esoBB installer has encountered a nasty error which is making it impossible to install a forum on your server. But don't feel down, <strong>here are a few things you can try</strong>:",
"Try again. Everyone makes mistakes: maybe the computer made one this time." => "<li><strong>Try again.</strong> Everyone makes mistakes: maybe the computer made one this time.</li>",
"Go back and check your settings. In particular, make sure your database information is correct." => "<li><strong>Go back and check your settings.</strong> In particular, make sure your database information is correct.</li>",
"Get help. Go on the esoBB support forum to see if anyone else is having the same problem as you are. If not, open a new issue, including the error details below." => "<li><strong>Get help.</strong> Go on the <a href='https://forum.geteso.org' class='external' target='_blank'>esoBB support forum</a> to see if anyone else is having the same problem as you are. If not, open a new issue, including the error details below.</li>",
"Show error information" => "Show error information",
"Congratulations" => "Congratulations!",
"Your forum has been installed, and it should be ready to go. It's highly recommended that you remove the install folder to secure your forum." => "Your forum has been installed, and it should be ready to go. It's highly recommended that you <strong>remove the <code>install</code> folder</strong> to secure your forum.",
"Show advanced information" => "Show advanced information",
"Queries run" => "Queries run",
"Your forum title must consist of at least one character" => "Your forum title must consist of at least one character",
"Your forum description must consist of at least one character" => "Your forum description must consist of at least one character",
"The name you have entered is reserved and cannot be used" => "The name you have entered is reserved and cannot be used",
"You must enter a name" => "You must enter a name",
"You can't use any of these characters in your name: ! / % + -" => "You can't use any of these characters in your name: ! / % + -",
...
"The installer could not connect to the MySQL server. The error returned was" => "The installer could not connect to the MySQL server. The error returned was:",
"Table prefix can only contain letters, numbers, and underscores" => "Table prefix can only contain letters, numbers, and underscores",
"Table prefix must be 20 characters or less" => "Table prefix must be 20 characters or less",
"Table prefix must be at least 1 character" => "Table prefix must be at least 1 character",
"Character encoding must be one of" => "Character encoding must be one of:",
"Base URL must be a valid URL" => "Base URL must be a valid URL",
"SMTP port must be a number between 1 and 65535" => "SMTP port must be a number between 1 and 65535",
"Storage engine must be InnoDB or MyISAM" => "Storage engine must be InnoDB or MyISAM",
"Hashing method must be bcrypt or md5" => "Hashing method must be bcrypt or md5",
"The installer has detected that there is another installation of the software in the same MySQL database with the same table prefix. The conflicting tables are" => "The installer has detected that there is another installation of the software in the same MySQL database with the same table prefix. The conflicting tables are:",
"To overwrite this installation, click 'Next step' again. All data will be lost." => "To overwrite this installation, click 'Next step' again. <strong>All data will be lost.</strong>",
"If you wish to create another installation alongside the existing one, change the table prefix." => "If you wish to create another installation alongside the existing one, <strong>change the table prefix</strong>.",
"Your forum is already installed. To reinstall your forum, you must remove install/lock." => "<strong>Your forum is already installed.</strong><br/><small>To reinstall your forum, you must remove <strong>install/lock</strong>.</small>",
"Your forum can't seem to lock the installer. Please manually delete the install folder, otherwise your forum's security will be vulnerable." => "Your forum can't seem to lock the installer. Please manually delete the install folder, otherwise your forum's security will be vulnerable.",
"Installer is locked by another process." => "Installer is locked by another process.",
"Invalid security token. Please refresh the page and try again." => "Invalid security token. Please refresh the page and try again.",
...
<ul>
<li><strong><a href='javascript:window.location.reload()'>Reload the page</a></strong>.</li>
<li>If you are the forum administrator, <strong>get help on <a href='https://geteso.org'>geteso.org</a></strong>.</li>
</ul>",
"First" => "First",
...
"registrationAuto" => "automatically",
"registrationEmail" => "by email verification",
...
"avatarError" => array("class" => "warning","message" => "There was a problem uploading your avatar. Make sure you are using a valid image type (.jpg, .png, or .gif) and the file does not exceed the maximum upload size of the server."),
...
"beenLoggedOut" => array("class" => "warning","message" => "You seem to have been <strong>logged out</strong> since you loaded this page. Please reenter your password below or press <strong>cancel</strong> to ignore this message.<br/><br/>Enter the password for <strong>%s</strong>: %s"),
"cannotViewConversation" => array("class" => "warning","message" => "This conversation cannot be viewed. It may have been deleted or turned into a private conversation."),
...
"changeYourName" => array("class" => "info","message" => "Once you change your name, your old name will be made available."),
"conversationDeleted" => array("class" => "success","message" => "The conversation was deleted."),
"downloadLanguagePacks" => array("class" => "info", "message" => "You can download more language packages from the <a href='https://geteso.org/languages/'>esoBB website</a>."),
"downloadPlugins" => array("class" => "info","message" => "You can download more plugins from the <a href='https://geteso.org/plugins/'>esoBB website</a>."),
"downloadSkins" => array("class" => "info","message" => "You can download more skins from the <a href='https://geteso.org/skins/'>esoBB website</a>."),
...
"emailTaken" => array("class" => "warning","message" => "There is already a member with this email address."),
"emptyPost" => array("class" => "warning","message" => "Your post cannot be submitted with no content."),
"emptyTitle" => array("class" => "warning","message" => "The title of your conversation may not be blank."),
"forgotPassword" => array("class" => "info","message" => "If you have forgotten your password, we'll send you a link to a page where you can choose a new one. Please enter your email address (and check your spam folder if the email doesn't arrive within the next minute or two)."),
